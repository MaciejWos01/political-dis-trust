...
twitter_handles_institutions = [r"@NWDUSACE", r"@medicarepayment", r"@Southcom", r"@USACEGALVESTON", r"@NatLabRockies", r"@NLM_NIH", r"@voakorea", r"@USACEHQ", r"@Research_USDOT", r"@USDOL", r"@SecWar", r"@VozdeAmerica", r"@USAGM", r"@WHOMB", r"@USPBGC", r"@federallabs", r"@USIP", r"@usagmceo", r"@ILAB_DOL", r"@bts_usdot", 
                                ...
                                r"@DOIONRR", r"@OCS_ACFgov", r"@usiporgold", r"@UnderSecT", r"@BEPgov", r"@martinoticias", r"@DeptofWar", r"@CivilRights", r"@NTISInfo", r"@NIH_NHLBI", r"@USAfricaCommand", r"@WesternAreaPowr", r"@USADF", r"@National_Ag_Lib", r"@CDCEnvironment", r"@NationalParkFdn", r"@USACELRD", r"@ENERGY", 
                                ...
                                r"@AccessBoard", r"@ACFHHS", r"@ACLgov", r"@ACUSgov", r"@AmeriCorps", r"@AmeriCorpsSr", r"@ARCgov", r"@ATFHQ", r"@BerkeleyLab", r"@BISgov", r"@BonnevillePower", r"@BrookhavenLab", r"@BSEEgov", r"@CBP", r"@CDCgov", r"@CDCNPIN", r"@CENTCOM", r"@CFAgov", r"@chemsafetyboard", r"@CIA", r"@CivilRights", r"@CMSGov", 
                                r"@CommerceGov", r"@ConstitutionCtr", r"@COPSOffice", r"@CopyrightOffice", r"@CRS4Congress", r"@DARPA", r"@DC_CSOSA", r"@DCSAgov", r"@DEAHQ", r"@DefenseHealth", r"@DefenseIntel", r"@DenaliComm", r"@DeptVetAffairs", r"@DFCgov", r"@DHSgov", r"@DHSOIG", r"@doddtra", r"@dodpaa", r"@doescience", r"@DOJ_EOIR", r"@DOTMARAD", 
                                r"@DRBC1961", r"@ED_OESE", r"@EDcivilrights", r"@EDPostsecondary", r"@EIAgov", r"@ElderJustice", r"@ENERGY", r"@EnergyDems", r"@EnergyGOP", r"@EPA", r"@EPWCmte", r"@FAANews", r"@FAFSA", r"@FBI", r"@FCAgov", r"@FDICgov", r"@FEC", r"@FedRegister", r"@FERC", r"@Fermilab", r"@FHFA", r"@FireScienceGov", r"@FiscalService", 
                                r"@fmc_gov", r"@FMCSA", r"@forestservice", r"@FTA_DOT", r"@FTC", r"@FVAP", r"@GinnieMaeGov", r"@GovNuclear", r"@HASCDemocrats", r"@HASCRepublicans", r"@HelsinkiComm", r"@HHSgov", r"@HHSGov", r"@HHSOCR", r"@HolocaustMuseum", r"@HouseBudgetDems", r"@HouseBudgetGOP", r"@HouseCommerce", r"@HouseDemocrats", r"@HouseForeign", 
                                r"@HouseGOP", r"@HouseIntel", r"@HouseJudiciary", r"@HouseScience", r"@HouseSmallBiz", r"@HouseVetAffairs", r"@HRSAgov", r"@HUDgov", r"@ICEgov", r"@IESResearch", r"@IHSgov", r"@INDOPACOM", r"@INL", r"@INTERPOL_HQ", r"@IRSnews", r"@JCCIC", r"@JudiciaryGOP", r"@kencen", r"@librarycongress", r"@LosAlamosNatLab", r"@LSCtweets", 
                                r"@MACPACgov", r"@MarineMammalCom", r"@MCCgov", r"@MedicaidGov", r"@MinorityHealth", r"@MSHA_DOL", r"@NASA", r"@NASA_Johnson", r"@NASAArtemis", r"@NASAClimate", r"@NASAEarth", r"@NASAExoplanets", r"@NASAHubble", r"@NASAMars", r"@NASAWebb", r"@NatReconOfc", r"@NavalInstitute", r"@NCPCgov", r"@NDU_EDU", r"@NEAarts", r"@NEHgov", 
                                r"@NGA_GEOINT", r"@NHTSAgov", r"@NIAIDNews", r"@NIDDKgov", r"@NIFC_Fire", r"@NIGCgov", r"@NIH", r"@NIH_NCCIH", r"@NIH_NIAMS", r"@NIOSH", r"@NIST", r"@NLRB", r"@NOAA", r"@NOAAClimate", r"@NOAAComms", r"@NOAAFisheries", r"@noaaocean", r"@NOAAResearch", r"@NPICatOSU", r"@NRCgov", r"@NSAGov", r"@NTIAgov", r"@NTSB", r"@NWS", 
                                r"@ODNIgov", r"@OfficeGovEthics", r"@OfficialFBOP", r"@OJPNIJ", r"@ORNL", r"@OSHA_DOL", r"@OSMRE", r"@OSTIgov", r"@OVWJustice", r"@PardonAttorney", r"@parentcenterhub", r"@PCLOB_GOV", r"@PeaceCorps", r"@PFPAOfficial", r"@PHMSA_DOT", r"@PostalRegulator", r"@RadioFreeAsia", r"@RadioSawa", r"@RFERL", r"@samhsagov", r"@SecretService", 
                                r"@SenateBanking", r"@SenateDems", r"@SLACLab", r"@smithsonian", r"@SocialSecurity", r"@Southcom", r"@SRBCnews", r"@SSS_gov", r"@StateDept", r"@StateJustice", r"@STBgov", r"@StennisCenter", r"@thejointstaff", r"@TheJusticeDept", r"@theNCI", r"@TheNCUA", r"@TheWilsonCenter", r"@TradeGov", r"@TrumanScholars", r"@TSA", r"@TVAnews", 
                                r"@UdallFoundation", r"@US_CYBERCOM", r"@US_EDA", r"@US_EUCOM", r"@US_FDA", r"@US_IMLS", r"@US_OSC", r"@US_Stratcom", r"@US_TRANSCOM", r"@usabmc", r"@USACEHQ", r"@USACHP", r"@USArmy", r"@usbr", r"@USCCRgov", r"@uscensusbureau", r"@USCG", r"@USCGAcademy", r"@USCGAux", r"@USCIRF", r"@USCIS", r"@uscourts", r"@USCPSC", r"@USDA", 
                                r"@USDA_AMS", r"@USDA_APHIS", r"@USDA_ARS", r"@USDA_ERS", r"@usda_nass", r"@USDA_NIFA", r"@USDA_NRCS", r"@USDAFoodSafety", r"@USDAForeignAg", r"@usdaRD", r"@usdaRMA", r"@USDOTFHWA", r"@USDOTFRA", r"@usedgov", r"@USEEOC", r"@usfire", r"@USFleetForces", r"@USFWS", r"@USFWSBirds", r"@USGAO", r"@USGPO", r"@USGS", r"@USGSA", 
                                r"@USHouseHistory", r"@USMBDA", r"@USMC", r"@usmint", r"@USMSPB", r"@USNatArchives", r"@USNationalGuard", r"@USOCC", r"@USOPM", r"@USPS", r"@uspto", r"@USTDA", r"@USTradeRep", r"@USTreasury", r"@USUN", r"@VANatCemeteries", r"@VeteransHealth", r"@VOAChinese", r"@VOANews", r"@VOAUrdu", r"@WestPoint_USMA", r"@WhiteHouse", 
                                r"@YourCommissary", r"@ANA_ACFgov", r"@SenateBudget", r"@CAAFlog", r"@CBP", r"@USCFOCouncil", r"@PretrialDC", r"@DefenseDSCA", r"@FPSDHS", r"@J_USFC", r"@JamesMadisonFdn", r"@OJPgov", r"@HRSAgov", r"@usdaFSA", r"@USUhealthsci", r"@BEA_News", r"@BJSgov", r"@BLMNational", r"@BLS_gov", r"@BudgetGOP", r"@CapitolPolice", 
                                r"@CFPBMilitary", r"@CFTC", r"@EACgov", r"@EximBankUS", r"@FDAfood", r"@federalreserve", r"@FedStats", r"@fema", r"@FitnessGov", r"@IAFgrassroots", r"@IRStaxpros", r"@JusticeATR", r"@NASAKennedy", r"@NatlParkService", r"@ngadc", r"@NNSANews", r"@NSF", r"@ONDCP", r"@OversightGov", r"@PNNLab", r"@PresidioSF", r"@SandiaLabs", 
                                r"@SenateAgDems", r"@SenateGOP", r"@SSABgov", r"@TravelGov", r"@US_SpaceCom", r"@USAfricaCommand", r"@usairforce", r"@USCBO", r"@USDOT", r"@USIndianAffairs", r"@USMarshalsHQ", r"@USNavy", r"@USSOCOM", r"@VAVetBenefits", r"@VETS_DOL", r"@visitthecapitol", r"@WB_DOL", r"@WHOSTP", r"@VP", r"@UnderSecPD", r"@FVAP", r"@StateDept", 
                                r"@SECGov", r"@SecVecAffairs", r"@SeawayUSDOT", r"@USNavy", r"@NASA", r"@DOLJobCorps", r"@TradeGov", r"@fgdcgov", r"@DoWDISA", r"@WHCabinet46"]
...
def output_name_for_zip(zip_path):
    """Return output name foo.jsonl for foo.jsonl.zip or foo.zip."""
    name = Path(zip_path).name
    lower = name.lower()
    if lower.endswith('.jsonl.zip'):
        return name[:-4]  # remove only .zip, keep .jsonl
    if lower.endswith('.zip'):
        return name[:-4] + '.jsonl'
    return name + '.jsonl'


def iter_jsonl_members(zip_file):
    """Yield candidate JSONL members inside a zip archive."""
    members = [info for info in zip_file.infolist() if not info.is_dir()]
    jsonl_members = [info for info in members if info.filename.lower().endswith('.jsonl')]
    return jsonl_members or members


def make_output_object(data, matched_terms):
    """Create the filtered output row. Missing optional fields become None."""
    return {
        'id': data.get('id'),
        'text': data.get('text'),
        'lang': data.get('lang'),
...
def process_zip_file(input_zip_path, output_dir, progress_every=PROGRESS_EVERY, overwrite=False):
    """Filter one .jsonl.zip file and write one .jsonl output file."""
    input_zip_path = Path(input_zip_path)
    output_dir = Path(output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)
    output_file = output_dir / output_name_for_zip(input_zip_path)

    if output_file.exists() and not overwrite:
        return {
            'input': str(input_zip_path),
    ...
    print(f'[{input_zip_path.name}] Reading -> {output_file}', flush=True)

    with zipfile.ZipFile(input_zip_path, 'r') as zf, \
         open(output_file, 'w', encoding='utf-8', buffering=OUTFILE_BUFFER_BYTES) as outfile:

        members = iter_jsonl_members(zf)
        if not members:
            raise RuntimeError(f'No files found inside {input_zip_path}')

        for member in members:
            print(f'[{input_zip_path.name}] Processing member {member.filename}', flush=True)
            with zf.open(member, 'r') as raw, \
                 io.TextIOWrapper(raw, encoding='utf-8', errors='replace') as infile:
                ...
                for line in infile:
                    ...
                    matched_terms = extract_matched_terms(text)

                    if matched_terms:
                        outfile.write(_dumps_obj(make_output_object(data, matched_terms)) + '\n')
                        written += 1
    ...
    print(
        f'[{input_zip_path.name}] Done. processed={processed:,} written={written:,} '
        f'skipped={skipped:,} seconds={seconds:.1f} output={output_file}',
        flush=True,
    )
    return {
        'input': str(input_zip_path),
...
def discover_input_files(input_dir):
    ...
    return sorted(input_dir.glob('*.jsonl.zip'))


def parse_args():
    parser = argparse.ArgumentParser(
        description='Filter every .jsonl.zip file in data/ and write matching tweets to filtered-data/*.jsonl.'
    )
    parser.add_argument(
        '--input-dir',
        default='data',
        help='Folder containing .jsonl.zip input files. Default: data',
    )
    parser.add_argument(
        '--output-dir',
        default='filtered-data',
        help='Folder for filtered .jsonl output files. Default: filtered-data',
    )
    parser.add_argument(
        '--workers',
        type=int,
        default=None,
        help='Number of files to process in parallel. Default: min(number of files, CPU cores).',
    )
    parser.add_argument(
        '--progress-every',
        type=int,
        default=PROGRESS_EVERY,
        help=f'Log progress every N input lines per file. Default: {PROGRESS_EVERY}',
    )
    parser.add_argument(
        '--force',
        action='store_true',
        help='Overwrite output files that already exist. Without this, existing outputs are skipped.',
    )
...
def main():
    ...
    if not input_files:
        print(f'No .jsonl.zip files found in {input_dir}', file=sys.stderr)
        return 2

    cpu_count = os.cpu_count() or 1
    workers = args.workers if args.workers is not None else min(len(input_files), cpu_count)
    workers = max(1, min(workers, len(input_files)))

    output_dir.mkdir(parents=True, exist_ok=True)

    print(f'Found {len(input_files)} .jsonl.zip files in {input_dir}', flush=True)
    print(f'Writing outputs to {output_dir}', flush=True)
    print(f'Using {workers} worker process(es)', flush=True)
    ...
    with ProcessPoolExecutor(max_workers=workers) as executor:
        ...
        for future in as_completed(future_to_file):
            ...
            try:
                ...
                print(
                    f"SUMMARY {Path(result['input']).name}: {result['status']} | "
    ...
    print('\nAll done.', flush=True)
    print(f'Files processed: {ok}', flush=True)
    print(f'Files skipped because output exists: {skipped_existing}', flush=True)
    print(f'Files failed: {len(failures)}', flush=True)
    print(f'Total lines processed: {total_processed:,}', flush=True)
    print(f'Total lines written: {total_written:,}', flush=True)
    print(f'Total lines skipped: {total_skipped:,}', flush=True)
